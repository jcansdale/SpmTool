...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template mode="namevalue" match="text()">
    <xsl:value-of select="." />
  </xsl:template>
  ...
  <xsl:template mode="namevalue" match="*[@Type='Array']">
    <xsl:copy>
      <xsl:apply-templates select="@*" />
      <xsl:apply-templates mode="namevalue" select="Element" />
    </xsl:copy>
  </xsl:template>

  <xsl:template mode="namevalue" match="Element">
    <xsl:copy>
      <xsl:value-of select="." />
    </xsl:copy>
  </xsl:template>
      ...
      <xsl:choose>
        ...
        <xsl:when test="/SPM/Sail/Motor='SpoilStk'">
          ...
          <assignedCurve Type="Array">
            <xsl:choose>
              <xsl:when test="/SPM/RAE-Mix/activePositions='%0000'">
                <Element>0</Element><Element>0</Element><Element>0</Element><Element>0</Element>
              </xsl:when>
              <xsl:when test="/SPM/RAE-Mix/activePositions='%0001'">
                <Element>1</Element><Element>0</Element><Element>0</Element><Element>0</Element>
              </xsl:when>
              <xsl:when test="/SPM/RAE-Mix/activePositions='%0002'">
                <Element>0</Element><Element>1</Element><Element>0</Element><Element>0</Element>
              </xsl:when>
              <xsl:when test="/SPM/RAE-Mix/activePositions='%0003'">
                <Element>1</Element><Element>1</Element><Element>0</Element><Element>0</Element>
              </xsl:when>
              <xsl:when test="/SPM/RAE-Mix/activePositions='%0004'">
                <Element>0</Element><Element>0</Element><Element>1</Element><Element>0</Element>
              </xsl:when>
              <xsl:when test="/SPM/RAE-Mix/activePositions='%0005'">
                <Element>1</Element><Element>0</Element><Element>1</Element><Element>0</Element>
              </xsl:when>
              <xsl:when test="/SPM/RAE-Mix/activePositions='%0006'">
                <Element>0</Element><Element>1</Element><Element>1</Element><Element>0</Element>
              </xsl:when>
              <xsl:when test="/SPM/RAE-Mix/activePositions='%0007'">
                <Element>1</Element><Element>1</Element><Element>1</Element><Element>0</Element>
              </xsl:when>
              <xsl:when test="/SPM/RAE-Mix/activePositions='%0008'">
                <Element>0</Element><Element>0</Element><Element>0</Element><Element>1</Element>
              </xsl:when>
              <xsl:when test="/SPM/RAE-Mix/activePositions='%0009'">
                <Element>1</Element><Element>0</Element><Element>0</Element><Element>1</Element>
              </xsl:when>
              <xsl:when test="/SPM/RAE-Mix/activePositions='%000A'">
                <Element>0</Element><Element>1</Element><Element>0</Element><Element>1</Element>
              </xsl:when>
              <xsl:when test="/SPM/RAE-Mix/activePositions='%000B'">
                <Element>1</Element><Element>1</Element><Element>0</Element><Element>1</Element>
              </xsl:when>
              <xsl:when test="/SPM/RAE-Mix/activePositions='%000C'">
                <Element>0</Element><Element>0</Element><Element>1</Element><Element>1</Element>
              </xsl:when>
              <xsl:when test="/SPM/RAE-Mix/activePositions='%000D'">
                <Element>1</Element><Element>0</Element><Element>1</Element><Element>1</Element>
              </xsl:when>
              <xsl:when test="/SPM/RAE-Mix/activePositions='%000E'">
                <Element>0</Element><Element>1</Element><Element>1</Element><Element>1</Element>
              </xsl:when>
              <xsl:when test="/SPM/RAE-Mix/activePositions='%000F'">
                <Element>1</Element><Element>1</Element><Element>1</Element><Element>1</Element>
              </xsl:when>
            </xsl:choose>
          </assignedCurve>
          <Curvedata Type="Object">
            ...
            <X Type="Array">
              <Element>-1023</Element><Element>-511</Element><Element>0</Element><Element>511</Element><Element>1023</Element><Element>0</Element><Element>0</Element>
            </X>
            <Y Type="Array">
              <Element>-1023</Element><Element>-1023</Element><Element>-1023</Element><Element>-1023</Element><Element>-1023</Element><Element>0</Element><Element>0</Element>
            </Y>
          </Curvedata>
        </xsl:when>
        <xsl:when test="/SPM/Sail/Motor">
          ...
          <assignedCurve Type="Array">
            <xsl:choose>
              <xsl:when test="/SPM/RAE-Mix/activePositions='%0000'">
                <Element>0</Element><Element>0</Element><Element>0</Element>
              </xsl:when>
              <xsl:when test="/SPM/RAE-Mix/activePositions='%0001'">
                <Element>1</Element><Element>0</Element><Element>0</Element>
              </xsl:when>
              <xsl:when test="/SPM/RAE-Mix/activePositions='%0002'">
                <Element>0</Element><Element>1</Element><Element>0</Element>
              </xsl:when>
              <xsl:when test="/SPM/RAE-Mix/activePositions='%0003'">
                <Element>1</Element><Element>1</Element><Element>0</Element>
              </xsl:when>
              <xsl:when test="/SPM/RAE-Mix/activePositions='%0004'">
                <Element>0</Element><Element>0</Element><Element>1</Element>
              </xsl:when>
              <xsl:when test="/SPM/RAE-Mix/activePositions='%0005'">
                <Element>1</Element><Element>0</Element><Element>1</Element>
              </xsl:when>
              <xsl:when test="/SPM/RAE-Mix/activePositions='%0006'">
                <Element>0</Element><Element>1</Element><Element>1</Element>
              </xsl:when>
              <xsl:when test="/SPM/RAE-Mix/activePositions='%0007'">
                <Element>1</Element><Element>1</Element><Element>1</Element>
              </xsl:when>
            </xsl:choose>
          </assignedCurve>
          <Curvedata Type="Object">
    ...
    <xsl:copy>
      <xsl:choose>
        <xsl:when test="/SPM/Sail">
          <xsl:apply-templates select="@*" mode="namevalue" />
      ...
      <xsl:if test="Active">
        ...
        <mixRatio Type="Array">
          <xsl:for-each select="Active/Element">
            <xsl:choose>
              <xsl:when test="text()='Enabled'"><Element> 100</Element></xsl:when>
              <xsl:otherwise><Element> 0</Element></xsl:otherwise>
            </xsl:choose>
          </xsl:for-each>
        </mixRatio>
      </xsl:if>
...
-->  
  ...
  <xsl:template mode="top" match="FMode">
    <FMode>
      <xsl:choose>
        ...
        <xsl:otherwise>
          <xsl:apply-templates mode="namevalue" select="switch_a|switch_b|switch_c|size|data" />
        </xsl:otherwise>
      </xsl:choose>
    </FMode>
  ...
  <xsl:template mode="namevalue" match="RAE-Mix/percentAileron">
    <percentAileron><xsl:value-of select="text()" /></percentAileron>
    <percentAileronR><xsl:value-of select="text()" /></percentAileronR>
  </xsl:template>
  
  <xsl:template mode="namevalue" match="RAE-Mix/percentElevator">
    <percentElevator><xsl:value-of select="text()" /></percentElevator>
    <percentElevatorR><xsl:value-of select="-text()" /></percentElevatorR>
  </xsl:template>
  ...
  <xsl:template mode="namevalue" match="Spektrum/Name">
    <xsl:choose>
      <xsl:when test="$modelName">
        <Name Type="String"><xsl:value-of select="$modelName" /></Name></xsl:when>
      <xsl:otherwise>
        <Name Type="String"><xsl:value-of select="text()" /></Name></xsl:otherwise>
    </xsl:choose>
  </xsl:template>
  ...
  <xsl:template mode="namevalue" match="Servo/subTrim">
    <xsl:choose>  
      <xsl:when test="((/SPM/Spektrum/Generator='DX8' and substring(/SPM/Spektrum/VCode/text(),2)&lt;2.05) or (/SPM/Spektrum/Generator='DX7S' and substring(/SPM/Spektrum/VCode/text(),2)&lt;1.02)) and ../direction='Reverse'">
        <subTrim><xsl:value-of select="-text()" /></subTrim>
      </xsl:when>
      <xsl:otherwise>
        <subTrim><xsl:value-of select="text()" /></subTrim>
      </xsl:otherwise>
...
<!-- Swap and invert travelHigh when reversed for old versions -->
  <xsl:template mode="namevalue" match="Servo/travelLow">
    <xsl:choose>
      <xsl:when test="((/SPM/Spektrum/Generator='DX8' and substring(/SPM/Spektrum/VCode/text(),2)&lt;2.05) or (/SPM/Spektrum/Generator='DX7S' and substring(/SPM/Spektrum/VCode/text(),2)&lt;1.02)) and ../direction='Reverse'">
        <travelLow><xsl:value-of select="-../travelHigh/text()" /></travelLow>
      </xsl:when>
      <xsl:otherwise>
        <travelLow><xsl:value-of select="text()" /></travelLow>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>
...
<!-- Swap and invert travelLow when reversed for old versions -->
  <xsl:template mode="namevalue" match="Servo/travelHigh">
    <xsl:choose>
      <xsl:when test="((/SPM/Spektrum/Generator='DX8' and substring(/SPM/Spektrum/VCode/text(),2)&lt;2.05) or (/SPM/Spektrum/Generator='DX7S' and substring(/SPM/Spektrum/VCode/text(),2)&lt;1.02)) and ../direction='Reverse'">
        <travelHigh><xsl:value-of select="-../travelLow/text()" /></travelHigh>
      </xsl:when>
      <xsl:otherwise>
        <travelHigh><xsl:value-of select="text()" /></travelHigh>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>
...
<!-- Copy speed to downSpeed -->
  ...
  <xsl:template mode="namevalue" match="P-Mix/conditionID">
    <xsl:choose>
      ...
      <xsl:otherwise>
        <conditionID><xsl:apply-templates mode="mapvalue" select="." /></conditionID>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>
